...
public class CreateCrossChainWithdrawalOrder {
    ...
    public static void main(String[] args) {
        ...
        String signature = L2OrderSigner.signCrossChainWithdraw(l2KeyPair, apiCredential.getAccountId(),
                amount, clientId, expireTimeInHour, currency, address, fee, chainId);
        WithdrawalResult result = syncRequestClient.createCrossChainWithdrawalOrder(amount, clientId, expireTime,
